...
/**
 * Class definition for MigrateGovernorVideoTerms.
 */
class MigrateGovernorVideoTerms extends MigrateGovernorBase {
  /**
  ...
  public function __construct($args) {
    ...
    // Set up destination.
    $this->destination = new MigrateDestinationTerm('video_terms');
