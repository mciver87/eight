...
/**
 * Class definition for MigrateGovernorDocumentTerms.
 */
class MigrateGovernorDocumentTerms extends MigrateGovernorBase {
  /**
  ...
  public function __construct($args) {
    ...
    // Set up destination.
    $this->destination = new MigrateDestinationTerm('document_terms');
