...
/**
 * @file
 * Contains DOA menu/breadcrumb migration.
 */

class MigrateDOAPageMenu extends MigrateDOABase {
  /**
   * Constructor.
   */
  public function __construct($args) {
    ...
    $url_source = variable_get('nc_migrate_doa_page_menu', FALSE);
    if ($url_source) {
      $columns = array(
        0 => array('id', 'Menu ID'),
      ...
      $this->source = new MigrateDOACSVSource($url_source, $columns, $options);
    }
